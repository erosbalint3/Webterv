...
function deleteAllCards() {
  for (let i = 0; i < europeCardIds.length; i++) {
    if (document.getElementById(europeCardIds[i]) != null) {
      document.getElementById(europeCardIds[i]).remove();
    }
  }
  for (let i = 0; i < americaCardIds.length; i++) {
    if (document.getElementById(americaCardIds[i]) != null) {
      document.getElementById(americaCardIds[i]).remove();
    }
  }
  for (let i = 0; i < africaCardIds.length; i++) {
    if (document.getElementById(africaCardIds[i]) != null) {
      document.getElementById(africaCardIds[i]).remove();
    }
  }
  for (let i = 0; i < asiaCardIds.length; i++) {
    if (document.getElementById(asiaCardIds[i]) != null) {
      document.getElementById(asiaCardIds[i]).remove();
    }
  }
  for (let i = 0; i < australiaCardIds.length; i++) {
    if (document.getElementById(australiaCardIds[i]) != null) {
      document.getElementById(australiaCardIds[i]).remove();
    }
  }
}
